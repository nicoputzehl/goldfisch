		...
		<ScrollView style={styles.container}>
			...
			<View style={styles.colorSection}>
				...
				<View style={styles.colorRow}>
					...
					<View
						style={[styles.colorSwatch, { backgroundColor: colors.accentDark }]}
					>
			...
			<View style={styles.colorSection}>
				...
				<View style={styles.colorRow}>
					...
					<View
						style={[styles.colorSwatch, { backgroundColor: colors.warning }]}
					>
			...
			<View style={styles.spacingDemo}>
				<View
					style={[
						styles.spacingBlock,
						{ width: SPACING.xxl, height: SPACING.xxl },
					]}
				>
				...
				<View
					style={[
						styles.spacingBlock,
						{ width: SPACING.xl, height: SPACING.xl },
					]}
				>
				...
				<View
					style={[
						styles.spacingBlock,
						{ width: SPACING.lg, height: SPACING.lg },
					]}
				>
			...
			<View style={styles.borderRadiusDemo}>
				<View
					style={[styles.borderRadiusBlock, { borderRadius: BORDER_RADIUS.xs }]}
				>
					<Text style={styles.borderRadiusLabel}>XS</Text>
				</View>
				<View
					style={[styles.borderRadiusBlock, { borderRadius: BORDER_RADIUS.sm }]}
				>
					<Text style={styles.borderRadiusLabel}>SM</Text>
				</View>
				<View
					style={[styles.borderRadiusBlock, { borderRadius: BORDER_RADIUS.md }]}
				>
					<Text style={styles.borderRadiusLabel}>MD</Text>
				</View>
				<View
					style={[styles.borderRadiusBlock, { borderRadius: BORDER_RADIUS.lg }]}
				>
					<Text style={styles.borderRadiusLabel}>LG</Text>
				</View>
				<View
					style={[styles.borderRadiusBlock, { borderRadius: BORDER_RADIUS.xl }]}
				>
